...
namespace Code2015.EngineEx
{
    public class RtsCamera : Camera
    {
        ...
        protected float dMoveSpeed = 0.2f * MathHelper.Pi / 180;
        protected float dTurnSpeed = MathHelper.Pi / 90;
        ...
        public float Latitude
        {
            ...
            {
                latitude = value;
                if (latitude > MathHelper.Pi * 5 / 18f)
                    latitude = MathHelper.Pi * 5 / 18f;
                if (latitude < -MathHelper.Pi * 5 / 18f)
                    latitude = -MathHelper.Pi * 5 / 18f;
            }
        }
        ...
        void UpdateView()
        {
            ...
            Quaternion.CreateFromRotationMatrix(ref viewTrans, out orientation);
        }
        ...
        public override void GetSubareaProjection(ref Rectangle rect, out Matrix mat)
        {
            if (isPerspective)
            {
                Matrix.CreatePerspectiveOffCenter(rect.Left * NearPlaneWidth, rect.Right * NearPlaneWidth, rect.Top * NearPlaneHeight, rect.Bottom * NearPlaneHeight, NearPlane, FarPlane, out mat);
            }
            else
            {
                Matrix.CreateOrthographicOffCenter(rect.Left * NearPlaneWidth, rect.Right * NearPlaneWidth, rect.Top * NearPlaneHeight, rect.Bottom * NearPlaneHeight, NearPlane, FarPlane, out mat);
            }
        }
        ...
        public override void UpdateProjection()
        {
            ...
            else
            {
                ...
                Frustum.Projection = Matrix.CreateOrthographic(NearPlaneWidth, NearPlaneHeight, NearPlane, FarPlane);
        ...
        public float Height
        {
            ...
            set
            {
                if (value >= 30 && value < 75)
                {
                    ...
                    yaw = -MathHelper.ToRadians(30);// -MathEx.PIf / 4f;
        ...
        public override Matrix GetSMTrans() 
        {
            ...
            return Matrix.CreateLookAt(position - invT.Right * h * 0.5f, target, invT.Up);
        }
