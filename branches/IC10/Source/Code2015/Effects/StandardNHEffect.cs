...
{
    public class StandardNHEffectFactory : EffectFactory
    {
        static readonly string typeName = "StandardNH";
        ...
        public StandardNHEffectFactory(RenderSystem dev)
        {
            device = dev;
        }
        ...
        {
            return new StandardNHEffect(device);
        }
    ...
    class StandardNHEffect : RigidEffect
    {
        bool stateSetted;
        ...
        public unsafe StandardNHEffect(RenderSystem rs)
            : base(rs, StandardNHEffectFactory.Name, false)
        {
            ...
            fl = FileSystem.Instance.Locate("standardnh.cvs", GameFileLocs.Effect);
            vtxShader = LoadVertexShader(renderSys, fl);

            fl = FileSystem.Instance.Locate("standardnh.cps", GameFileLocs.Effect);
